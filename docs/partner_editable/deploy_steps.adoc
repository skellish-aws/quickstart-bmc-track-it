...
[cols="3,1"]
|===
^|https://fwd.aws/w93B9?[Deploy {partner-product-short-name} into a new VPC on AWS^]
^|https://fwd.aws/xNDNQ?[View template^]

^|https://fwd.aws/A979j?[Deploy {partner-product-short-name} into an existing VPC on AWS^]
^|https://fwd.aws/6AQvw?[View template^]
|===
+
